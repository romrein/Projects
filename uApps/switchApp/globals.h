...
#include "spiReadWriteSwitch.h"
#include "spiTransferCmdToSwitch.h"
#include "spiTransferFileToSwitch.h"
#include "WinTypes.h"
...
#define SWITCH_MAX_VLAN_ADDRESS						4095
#define SWITCH_MAX_VLAN_INDADDRESS					1023
#define SWITCH_BYTE_LENGTH							0x01
//#define SWITCH_READ_ACR								((uint8_t)(0x10))
#define SWITCH_READ_ACR								0x10
#define SWITCH_SINGLE_REG_LENGTH					0x01
